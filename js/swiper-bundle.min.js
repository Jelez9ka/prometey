...
!(function (e, t) {
  ...
  var I = {
    ...
    updateSlides: function () {
      ...
      if (
        (Object.assign(e, { slides: p, snapGrid: h, slidesGrid: g, slidesSizesGrid: v }), a.centeredSlides && a.cssMode && !a.centeredSlidesBounds)
      ) {
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < a.length; e += 1) {
        ...
        ((p >= 0 && p < t.size - 1) || (u > 1 && u <= t.size) || (p <= 0 && u >= t.size)) &&
          (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), a[e].classList.add(s.slideVisibleClass)),
          (l.progress = i ? -d : d),
    ...
    updateActiveIndex: function (e) {
      ...
      let p;
      (p =
        t.virtual && i.virtual.enabled && i.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute('data-swiper-slide-index') || d, 10) : d),
  ...
  var G = {
    ...
    slideToLoop: function (e, t, s, a) {
      ...
      let r = e;
      return (
        i.params.loop && (i.virtual && i.params.virtual.enabled ? (r += i.virtual.slidesBefore) : (r = i.getSlideIndexByData(r))),
        i.slideTo(r, t, s, a)
      );
    },
  ...
  function H(e) {
    ...
    if (!s.allowTouchMove)
      return (
        ...
        void (
          i.isTouched &&
          (Object.assign(n, { startX: m, startY: h, prevX: s.touches.currentX, prevY: s.touches.currentY, currentX: m, currentY: h }),
          (i.touchStartTime = l()))
        )
      );
  ...
  function Y(e) {
    ...
    i.rewind &&
      (t.isBeginning
        ? (w = t.params.virtual && t.params.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1)
        : t.isEnd && (v = 0));
    const b = (h - d[f]) / g,
        ...
        if (e)
          ...
          for (let e = c; e <= p; e += 1)
            if (e < y || e > E) {
              const t = C(e);
              s.slidesEl
                .querySelectorAll(`.${s.params.slideClass}[data-swiper-slide-index="${t}"], swiper-slide[data-swiper-slide-index="${t}"]`)
                .forEach((e) => {
                  e.remove();
                });
            }
      ...
      function p(e) {
        ...
        if (t.params.loop) {
          ...
          (a < t.loopedSlides || a > t.slides.length - t.loopedSlides) &&
            t.loopFix({ direction: a < t.loopedSlides ? 'prev' : 'next', activeSlideIndex: a, slideTo: !1 }),
            t.slideToLoop(a);
        } else t.slideTo(a);
      }
      function u() {
          ...
          if (
            (s.dynamicBullets &&
              ...
              s.dynamicMainBullets > 1 &&
                ...
                ((l += a - (t.previousIndex || 0)), l > s.dynamicMainBullets - 1 ? (l = s.dynamicMainBullets - 1) : l < 0 && (l = 0)),
              (o = Math.max(a - l, 0)),
        ...
        T = () => {
          ...
          const a = t.wrapperEl,
            r =
              ...
              a.getAttribute('id') ||
              `swiper-wrapper-${
                ((l = 16), void 0 === l && (l = 16), 'x'.repeat(l).replace(/x/g, () => Math.round(16 * Math.random()).toString(16)))
              }`;
          var l;
        ...
        p = () => {
          if (l && t.params.hashNavigation.enabled)
            if (t.params.hashNavigation.replaceState && d.history && d.history.replaceState)
              d.history.replaceState(null, null, `#${t.slides[t.activeIndex].getAttribute('data-hash')}` || ''), i('hashSet');
            else {
        ...
        (i.grid = {
          ...
          updateSlide: (e, r, n, l) => {
            ...
            if ('row' === p && o > 1) {
              ...
              'column' === p
                ? ((m = Math.floor(e / c)), (h = e - m * c), (m > a || (m === a && h === c - 1)) && ((h += 1), h >= c && ((h = 0), (m += 1))))
